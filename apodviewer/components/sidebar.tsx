  ...
  return(
    <div className="sidebar">
      <header className="sidebar-header">
        <a href="/"><h2>APODviewer</h2></a>
      </header>
      <nav className="sidebar-nav">
        <ul className="nav-list">
          <a href="" className="nav-link">
            <li className="nav-list-link-item">
          ...
          <a href="" className="nav-link">
            <li className="nav-list-link-item">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-rocket-fill" viewBox="0 0 16 16">
